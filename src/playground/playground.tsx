...
export const Playground = () => {
  ...
  const tableData: TableDataItem[] = [
    ...
    { id: 2, name: 'Maria Souza', email: 'maria@example.com', status: 'Ativo' },
    { id: 3, name: 'Carlos Oliveira', email: 'carlos@example.com', status: 'Inativo' },
    { id: 4, name: 'Ana Santos', email: 'ana@example.com', status: 'Ativo' },
  ];

  const tableColumns: TableColumn<TableDataItem, keyof TableDataItem>[] = [
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <section className="mb-12 p-6 border rounded-lg bg-white shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Auth Hook</h2>
      ...
      {/* Modal Section */}
      <section className="mb-12 p-6 border rounded-lg bg-white shadow-sm">
        <Title level={2} className="mb-4">Modal Component</Title>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button onClick={() => openModal('question')} variant="secondary">
                Question
              </Button>
            </div>
          </div>
        ...
        <Modal
          ...
          type={modalType}
          title={`Modal ${modalType.charAt(0).toUpperCase() + modalType.slice(1)}`}
      ...
      {/* Table Section */}
      <section className="mb-12 p-6 border rounded-lg bg-white shadow-sm">
        <Title level={2} className="mb-4">Table Component</Title>
        <div className="space-y-4">
          <Title level={3}>Tabela Básica</Title>
      ...
      <section className="mb-12 p-6 border rounded-lg bg-white shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="mt-6">
            ...
            <p className="text-blue-600">Este título tem uma cor azul aplicada.</p>
          </div>
        </div>
      </section>
    </div>
